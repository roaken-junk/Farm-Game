...
export const ARCADE = [
  {
    ...
    tag: 'Invaders',
    blurb: 'Keep the flock off your corn.',
    how: 'Drag anywhere to move. Seven crows in a row without a hit drops a ' +
         'power-up — catch it.',
    powers: [
      { icon: '💥', name: 'Buckshot', desc: 'Three kernels a shot, in a spread.' },
      { icon: '⚡', name: 'Rapid Fire', desc: 'Throws three times as fast.' },
      { icon: '🛡️', name: 'Shield', desc: 'Eats the next peck instead of a life.' },
    ],
  ...
  },
  {
    ...
    tag: 'Crossing',
    blurb: 'Get the hen home across the lanes.',
  ...
  },
  {
    ...
    tag: 'Snake',
    blurb: 'Eat the patch without doubling back.',
